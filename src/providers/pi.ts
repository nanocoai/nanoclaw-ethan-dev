 ...
 *     key being right there. By design upstream: the read lock coordinates
 *     OAuth token refresh between concurrent pi instances sharing one
 *     auth.json (earendil-works/pi#6406, closed no-action) — and refresh
 *     needs real writes anyway.
